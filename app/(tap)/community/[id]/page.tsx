    ...
    return (
        <div className="py-10">
            <div className="mt-4 flex space-x-2 mb-6">
                <h1 className="text-xl font-semibold">여기에 이제 제목이 들어감</h1>
                <span className="inline-flex items-center rounded-lg bg-blue-400 px-2 py-1 text-sm font-semibold text-white">맛집</span>
                <span className="inline-flex items-center rounded-lg  bg-blue-400 px-2 py-1 text-sm font-semibold text-white">관광지</span>
            ...
            <div className="space-y-4">
                <h2 className="text-base text-gray-800">테마 :</h2>
                <h2 className="text-base text-gray-800">출발지 :</h2>
                <h2 className="text-base text-gray-800">도착지 :</h2>
            </div>
            ...
            <div className="slider-container relative z-20">
                <Slider {...settings}>
                    <div style={{ borderRadius: '8px' }}>
                        <h3>
                        <Image src="/food1.jpg" className="rounded-lg shadow-md shadow-gray-400" alt="Description of the image" width="200" height="80"/>
                        </h3>
                    </div>
                    <div style={{ borderRadius: '8px' }}>
                        <h3>
                        <Image src="/food2.jpg" className="rounded-lg shadow-md shadow-gray-400" alt="Description of the image" width="200" height="80"/>
                        </h3>
                    </div>
                    <div>
                        <h3>
                        <Image src="/food3.jpg" className="rounded-lg shadow-md shadow-gray-400" alt="Description of the image" width="200" height="80"/>
                        </h3>
                    </div>
                    <div>
                        <h3>
                        <Image src="/food4.jpg" className="rounded-lg shadow-md shadow-gray-400" alt="Description of the image" width="200" height="80"/>
                        </h3>
                    </div>
                    <div>
                        <h3>
                        <Image src="/food5.jpg" className="rounded-lg shadow-md shadow-gray-400" alt="Description of the image" width="200" height="80"/>
                        </h3>
                    </div>
                    <div>
                        <h3>
                        <Image src="/food6.jpg" className="rounded-lg shadow-md shadow-gray-400" alt="Description of the image" width="200" height="80"/>
                        </h3>
                    </div>
                    <div>
                        <h3></h3>
            ...
            <div className="mt-20 space-y-6">
                <h2 className="text-base text-gray-800">첫번째 스팟 :</h2>
                <h2 className="text-base text-gray-800">두번째 스팟 :</h2>
                <h2 className="text-base text-gray-800">세번째 스팟 :</h2>
            </div>
            <h1 className="mt-14 font-semibold text-xl text-gray-800">이런사람에게 추천해요👍</h1>
