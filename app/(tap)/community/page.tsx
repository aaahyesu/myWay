        ...
        <div className="px-1">
            ...
            <div key={i} className="mt-8">
                ...
                <div className="mt-2 flex space-x-2 px-2">
                    <h1 className="font-Nanum text-black hover:text-gray-500 font-semibold">Title - instagram copycat</h1>
                ...
                <h1 className="mt-1 px-2 text-black hover:text-gray-500 font-Nanum text-sm">detail ~~~~~~</h1>
                </Link>
            </div>
            ))}
        </div>
